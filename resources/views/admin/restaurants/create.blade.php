        ...
        <div class="row">
            <div class="col">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" value="+39{{ old('phone') }}" required maxlength="13" placeholder="Inserisci il numero di telefono">
                    @error('phone')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
