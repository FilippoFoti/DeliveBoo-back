                ...
                <form action="{{ route('admin.restaurants.store') }}" method="POST" enctype="multipart/form-data" id="my-form">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('vat_number') is-invalid @enderror" id="vat_number"
                            name="vat_number" value="{{ old('vat_number') }}" required maxlength="13">
                        @error('vat_number')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                const form = document.getElementById('my-form'); // Aggiungi l'id "my-form" al tuo elemento form
                                const checkboxes = document.querySelectorAll('input[name="type_id[]"]');
                                const minRequired = 1; // Numero minimo di caselle di controllo richieste
                                ...
                                form.addEventListener('submit', function(event) {
                                    if (checkedCount < minRequired || checkedCount > maxAllowed) {
                                        ...
                                        document.getElementById('type-error').textContent = 'Seleziona almeno ' + minRequired + ' e al massimo ' + maxAllowed + ' tipi.';
                                    }
                                });
